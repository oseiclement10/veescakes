          ...
          <section className="grid grid-cols-2">
            <article className="mt-20">
              ...
              <p className="text-xl w-5/6 py-6 font-semibold">
                ...
                Welcome to the Veescakes experience, where joy is baked into
                every bite.
              </p>

              <button className="py-2 w-[160px] px-4 mt-8 rounded-3xl text-burgandyLight text-lg bg-burgandyDark">
                Place Order
              </button>
            </article>
